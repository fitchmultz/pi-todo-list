...
`/todos` shows the first page; `/todos toggle`, `/todos show`, and `/todos hide` control the widget. The widget starts hidden, and the footer status reports active and pending counts. Set `PI_TODO_WIDGET=show` to start it visible instead.
